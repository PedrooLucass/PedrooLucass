...
<li><img  width="26" height="26" alingn="left" src="./img//spring.png" alt="Spring Framework" /><i> Spring Framework</i></li>
<li><img  width="26" height="26" alingn="left" src="./img//postgresql.png" alt="PostgreSQL" /><i> PostgreSQL</i></li>
<li><img  width="26" height="26" alingn="left" src="./img//docker.png" alt="Docker" /><i> Docker</i></li>
<li><img  width="26" height="26" alingn="left" src="./img//postman.png" alt="Postman" /><i> Postman</i></li>
<li><img  width="26" height="26" alingn="left" src="./img//javascript.png" alt="JavaScript" /><i> Linguagem JavaScript</i></li>
